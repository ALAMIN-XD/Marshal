...
def logo():
    ...
    print("\033[94m│    \033[92m▒█░▒█ ▒█▄▄█ ▒█░▒█ ▒█░░▒█ ▄█▄ ▒█░░▀█\033[94m   │".center(column1))
    print("\033[94m│                                        │".center(column2))
    print("\033[94m│ \033[95mAuthor : Md. Alamin Islam              \033[94m│".center(column1))
    print("\033[94m│ \033[95mTool   : Encode Python2 and Python3    \033[94m│".center(column1))
    print("\033[94m│ \033[95mGitHub : atalamin \033[94m│".center(column1))
...
def logout():
    ...
    print("\033[93m[ \033[92mhttps://github.com/atalamin/ \033[93m]\033[37m\n".center(column3))
    sys.exit()
...
marshalHead = "# Encoded By PyEncryptor\n# A Product Of atalamin\n# https://github.com/atalamin\n\nimport marshal\nexec(marshal.loads("
...
def encodeMarshal(data, power):
    ...
    for i in range(power):
        code = compile(powerData, "atalamin", "exec")
...
def update():
    ...
    try:
        mainVersion = requests.get("https://raw.githubusercontent.com/atalamin/PyEncryptor/main/.version").text
    except:
    ...
    if (toolVersion == mainVersion):
        ...
        os.system("cd .. && rm -rf PyEncryptor && git clone https://github.com/atalamin/PyEncryptor > /dev/null 2>&1")
